...
export default function CustomDrawer({ navigation }) {
  ...
  const menuOptions = [{ optionName: "Locations On Map", key: "saved-locations", navigationScreen: "SavedLocations", iconName: "location-outline" }];
  ...
  return (
    <View style={styles.container}>
      ...
      {menuOptions.map(({ optionName, key, iconName, navigationScreen }) => (
        <TouchableOpacity onPress={() => navigation.navigate(navigationScreen)} key={key} style={styles.menuButton}>
